...
var MethodsToMap = map[string][]string{
	...
	"IWorldNameable":          {"getDisplayName"},
	"AxisAlignedBB":           {"expand", "calculateIntercept", "isVecInside", "<init>"},
	...
	"Entity":                  {"isEntityAlive", "isInvisible", "isSprinting", "isSneaking", "setSprinting", "getName", "getDisplayName", "getDistanceToEntity", "canBeCollidedWith", "getCollisionBorderSize", "hashCode", "getLook", "getPositionEyes"},
	"BlockPos":                {"<init>"},
